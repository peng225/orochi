...
type ServerInterface interface {
	...
	// Delete a bucket
	// (DELETE /bucket/{name})
	DeleteBucket(w http.ResponseWriter, r *http.Request, name BucketName)
	// Update a bucket status to "deleted"
	// (PUT /bucket/{name})
	UpdateBucketStatusToDeleting(w http.ResponseWriter, r *http.Request, name BucketName)
}
...
func (siw *ServerInterfaceWrapper) DeleteBucket(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteBucket(w, r, name)
	}))
...
// UpdateBucketStatusToDeleting operation middleware
func (siw *ServerInterfaceWrapper) UpdateBucketStatusToDeleting(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateBucketStatusToDeleting(w, r, name)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("DELETE "+options.BaseURL+"/bucket/{name}", wrapper.DeleteBucket)
	m.HandleFunc("PUT "+options.BaseURL+"/bucket/{name}", wrapper.UpdateBucketStatusToDeleting)
